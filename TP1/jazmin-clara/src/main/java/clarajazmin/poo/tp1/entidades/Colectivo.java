...
/**
 * Clase hija o subclase que extiende de clase Vehiculo.
 * Clase final indica que Colectivo no puede tener subclases, que no puede
 * extenderse
 */
public final class Colectivo extends Vehiculo {
    ...
    public Colectivo(String marca, String modelo, String color, float precio) {
    ...
    public Colectivo(String marca, String modelo, String color, float precio, Radio radio) {
